...
\begin{longtable}{|p{4.5cm}|p{2.8cm}|p{2.8cm}|p{2.8cm}|p{3cm}|}
\hline
...
Email Spam Classification & Binary Classification (Supervised), text data & TF-IDF weighting, Mutual Information & Naive Bayes, Logistic Regression, SVM & Varies (UCI/Kaggle) \\ \hline
...
\begin{longtable}{|p{4cm}|p{5cm}|p{2.5cm}|p{2.5cm}|}
\hline
...
\vspace{0.3cm}
\textbf{Classification -- Breast Cancer}
\begin{tabular}{lccccc}
\toprule
Model & Accuracy & Precision & Recall & F1-score & ROC-AUC\\
\midrule
...
\vspace{0.3cm}
\textbf{Classification -- Digits (MNIST proxy)}
\begin{tabular}{lccccc}
\toprule
Model & Accuracy & Precision & Recall & F1-score & ROC-AUC\\
\midrule
