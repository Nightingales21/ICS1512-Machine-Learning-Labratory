...
\texttt{ApplicantIncome} is the highest-variance numeric feature by a wide
...
\textbf{Table 1: Hyperparameter Tuning Summary}
\begin{tabular}{lllc}
\toprule
...
\textbf{Table 2: Cross-Validation Performance (K = 5, on training data)}
\begin{tabular}{lcccc}
\toprule
...
\vspace{0.3cm}
\textbf{Table 3: Test Set Performance}
\begin{tabular}{lcccc}
\toprule
Model & MAE & MSE & RMSE & $R^2$ \\
\midrule
...
\label{fig:coef}
\end{figure}
\textbf{Table 4: Coefficient Comparison (top 3 features)}
\begin{tabular}{lcccc}
\toprule
