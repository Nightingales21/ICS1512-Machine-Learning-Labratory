...
\begin{center}
\begin{minipage}{\linewidth}\centering
\textbf{Na\"ive Bayes Comparison}\par\smallskip
\begin{fitwidth}
...
\begin{center}
\begin{minipage}{\linewidth}\centering
\textbf{KNN Comparison (varying $k$, Euclidean, uniform weights, scaled features)}\par\smallskip
\begin{fitwidth}
\begin{tabular}{lcccc}
\toprule
...
\begin{center}
\begin{minipage}{\linewidth}\centering
\textbf{GridSearchCV vs. RandomizedSearchCV}\par\smallskip
\begin{fitwidth}
\begin{tabular}{lcc}
\toprule
...
\begin{center}
\begin{minipage}{\linewidth}\centering
\textbf{KDTree vs. BallTree} (best tuned KNN: $k=9$, manhattan, distance-weighted)\par\smallskip
\begin{fitwidth}
\begin{tabular}{lcc}
\toprule
...
\begin{center}
\begin{minipage}{\linewidth}\centering
\textbf{Cross Validation (5-fold, Bernoulli NB vs. Best Tuned KNN)}\par\smallskip
\begin{fitwidth}
\begin{tabular}{lcc}
\toprule
...
\begin{center}
\begin{minipage}{\linewidth}\centering
\textbf{Theoretical Time Complexity}\par\smallskip
\begin{fitwidth}
\begin{tabular}{lcc}
\toprule
...
\begin{center}
\begin{minipage}{\linewidth}\centering
\textbf{Experimental Time Analysis}\par\smallskip
\begin{fitwidth}
\begin{tabular}{lcc}
\toprule
...
\begin{center}
\begin{minipage}{\linewidth}\centering
\textbf{Different train-test splits (Best tuned KNN):}\par\smallskip
\begin{fitwidth}
\begin{tabular}{lc}
\toprule
Test Size & Accuracy \\
...
\end{minipage}
\end{center}
\noindent Accuracy is fairly stable (0.907--0.931) across all four splits,
...
\begin{center}
\begin{minipage}{\linewidth}\centering
\textbf{Euclidean vs. Manhattan distance ($k=9$):}\par\smallskip
\begin{fitwidth}
\begin{tabular}{lc}
\toprule
Distance & Accuracy \\
...
\end{minipage}
\end{center}
\noindent On the single 80/20 test split Euclidean is marginally ahead, but the
...
\begin{center}
\begin{minipage}{\linewidth}\centering
\textbf{Weighted KNN ($k=9$):}\par\smallskip
\begin{fitwidth}
\begin{tabular}{lc}
\toprule
Weighting & Accuracy \\
...
\end{minipage}
\end{center}
\noindent Distance-weighting improves accuracy by giving closer neighbors more
...
accuracy/\allowbreak precision/\allowbreak recall/\allowbreak F1, ROC-AUC, 5-fold cross-validation, and
